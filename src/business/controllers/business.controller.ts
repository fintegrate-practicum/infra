...
export class businessController {
  ...
  @Put('id')
  async updateBusinessById(@Param('id') id: string, @Body() newData: CreateBusinessDto): Promise<CreateBusinessDto> {
    const updatedBusiness = this.businessService.updateBusinessById(id, newData);
